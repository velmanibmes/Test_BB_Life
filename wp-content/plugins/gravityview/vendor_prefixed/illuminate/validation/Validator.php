...
use GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Support\MessageBag;
use GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Contracts\Container\Container;
use GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator;
use GravityKit\GravityView\Symfony\Component\HttpFoundation\File\UploadedFile;
use GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Contracts\Validation\Validator as ValidatorContract;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @var \GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Support\MessageBag
     */
    protected $messages;
     ...
     *
     * @param  \GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
     ...
     * @return void
     *
     * @throws \GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Validation\ValidationException
     */
     ...
     *
     * @return \GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Support\MessageBag
     */
    ...
    {
        if ($extensions) {
            $keys = array_map('\GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Support\Str::snake', array_keys($extensions));
    ...
    {
        if ($replacers) {
            $keys = array_map('\GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Support\Str::snake', array_keys($replacers));
     ...
     *
     * @return \GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \GravityKit\GravityView\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator
     */
