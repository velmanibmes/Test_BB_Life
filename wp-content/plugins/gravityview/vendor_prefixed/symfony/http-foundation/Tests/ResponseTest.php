...
use GravityKit\GravityView\Symfony\Component\HttpFoundation\Response;
...
class ResponseTest extends ResponseTestCase
{
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityView\Symfony\Component\HttpFoundation\Response', $response);
    ...
    {
        $headerMock = $this->getMockBuilder('GravityKit\GravityView\Symfony\Component\HttpFoundation\ResponseHeaderBag')->setMethods(['set'])->getMock();
