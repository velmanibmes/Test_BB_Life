...
namespace GravityKit\GravityView\Symfony\Component\Finder\Tests;

use GravityKit\GravityView\Symfony\Component\Finder\Finder;

class FinderTest extends Iterator\RealIteratorTestCase
{
    public function testCreate()
    {
        $this->assertInstanceOf('GravityKit\GravityView\Symfony\Component\Finder\Finder', Finder::create());
    }
    ...
    {
        $this->assertInstanceOf('GravityKit\\GravityView\\Symfony\\Component\\Finder\\Finder', Finder::create()->append([]));
    }
    ...
    public function testAccessDeniedException()
    {
        ...
        if (false === $couldRead = is_readable($testDir)) {
            try {
                ...
                $expectedExceptionClass = 'GravityKit\\GravityView\\Symfony\\Component\\Finder\\Exception\\AccessDeniedException';
