...
use GravityKit\GravityView\Foundation\ThirdParty\Monolog\Handler\AbstractHandler;
...
class ErrorHandler
{
    ...
    public static function register(LoggerInterface $logger, $errorLevelMap = array(), $exceptionLevel = null, $fatalLevel = null)
    {
        ...
        class_exists('\\GravityKit\\GravityView\\Foundation\\ThirdParty\\Psr\\Log\\LogLevel', true);
