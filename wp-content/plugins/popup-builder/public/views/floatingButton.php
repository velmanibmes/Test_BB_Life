...
<div class="sgpb sgpb-wrapper sgpb-floating-btn-wrapper" id="sgpb-floating-btn-wrapper">
	<div class="formItem">
		<p class="formItem__title"><?php esc_html_e('Enable', 'popup-builder')?>:</p>
	...
	<div class="sgpb-width-100">
		<div class="subFormItem noMargin">
			<p class="formItem__title sgpb-margin-y-20"><?php esc_html_e('Style', 'popup-builder')?>:</p>
			<div class="subForm subForm_squared">
				<input type="button" class="sgpb-input-button sgpb-margin-right-20 sgpb-floating-button-style-corner js-floating-button-style squares__square buttonGroup__button<?php echo esc_attr(($popupTypeObj->getOptionValue('sgpb-floating-button-style') == 'corner') ? ' sgpb-input-button-active' : '');?>" value="<?php esc_html_e('Corner', 'popup-builder')?>" data-sgvalue="corner">
				<input type="button" class="sgpb-input-button sgpb-floating-button-style-basic js-floating-button-style squares__square buttonGroup__button<?php echo esc_attr(($popupTypeObj->getOptionValue('sgpb-floating-button-style') == 'basic') ? ' sgpb-input-button' : '');?>" value="<?php esc_html_e('Basic', 'popup-builder')?>" data-sgvalue="basic">
		...
		<div class="subFormItem sgpb-margin-bottom-30 sgpb-floating-btn-position-boxes-container">
			<p class="formItem__title sgpb-margin-y-20"><?php esc_html_e('Position', 'popup-builder')?>:</p>
			<div class="subForm subForm_squared">
				<input type="button" class="sgpb-input-button sgpb-floating-button-position-top-left js-floating-button-position buttonGroup__button<?php echo esc_attr(($popupTypeObj->getOptionValue('sgpb-floating-button-position') == 'corner') ? ' active' : '');?>" value="<?php esc_html_e('Top Left', 'popup-builder')?>" data-sgvalue="top-left">
				<input type="button" class="sgpb-input-button sgpb-margin-x-10 sgpb-floating-button-position-top-center js-floating-button-position buttonGroup__button<?php echo esc_attr(($popupTypeObj->getOptionValue('sgpb-floating-button-position') == 'basic') ? ' active' : '');?>" value="<?php esc_html_e('Top Center', 'popup-builder')?>" data-sgvalue="top-center">
				<input type="button" class="sgpb-input-button sgpb-floating-button-position-top-right js-floating-button-position buttonGroup__button<?php echo esc_attr(($popupTypeObj->getOptionValue('sgpb-floating-button-position') == 'basic') ? ' active' : '');?>" value="<?php esc_html_e('Top Right', 'popup-builder')?>" data-sgvalue="top-right">
			</div>
			<div class="subForm subForm_squared sgpb-margin-y-10">
				<input type="button" class="sgpb-input-button sgpb-floating-button-position-left-center js-floating-button-position buttonGroup__button<?php echo esc_attr(($popupTypeObj->getOptionValue('sgpb-floating-button-position') == 'basic') ? ' active' : '');?>" value="<?php esc_html_e('Left center', 'popup-builder')?>" data-sgvalue="left-center">
				...
				<input type="button" class="sgpb-input-button sgpb-floating-button-position-right-center js-floating-button-position buttonGroup__button<?php echo esc_attr(($popupTypeObj->getOptionValue('sgpb-floating-button-position') == 'basic') ? ' active' : '');?>" value="<?php esc_html_e('Right Center', 'popup-builder')?>" data-sgvalue="right-center">
			</div>
			<div class="subForm subForm_squared">
				<input type="button" class="sgpb-input-button sgpb-floating-button-position-bottom-left js-floating-button-position buttonGroup__button<?php echo esc_attr(($popupTypeObj->getOptionValue('sgpb-floating-button-position') == 'basic') ? ' active' : '');?>" value="<?php esc_html_e('Bottom Left', 'popup-builder')?>" data-sgvalue="bottom-left">
				<input type="button" class="sgpb-input-button sgpb-margin-x-10 sgpb-floating-button-position-bottom-center js-floating-button-position buttonGroup__button<?php echo esc_attr(($popupTypeObj->getOptionValue('sgpb-floating-button-position') == 'basic') ? ' active' : '');?>" value="<?php esc_html_e('Bottom Center', 'popup-builder')?>" data-sgvalue="bottom-center">
				<input type="button" class="sgpb-input-button sgpb-floating-button-position-bottom-right js-floating-button-position buttonGroup__button<?php echo esc_attr(($popupTypeObj->getOptionValue('sgpb-floating-button-position') == 'basic') ? ' active' : '');?>" value="<?php esc_html_e('Bottom Right', 'popup-builder')?>" data-sgvalue="bottom-right">
			</div>
		...
		<div class="formItem formItem_itemsCentered">
			<span class="formItem__title sgpb-margin-right-20"><?php esc_html_e('Font size', 'popup-builder')?>:</span>
		...
		<div class="sgpb-basic-button-style-options-wrapper-js<?php echo esc_attr(($popupTypeObj->getOptionValue('sgpb-floating-button-position') == 'corner') ? ' sgpb-hide' : ''); ?>">
			<div class="formItem formItem_itemsCentered">
				<span class="formItem__title sgpb-margin-right-20"><?php esc_html_e('Position top', 'popup-builder')?>:</span>
			...
			<div class="formItem formItem_itemsCentered">
				<span class="formItem__title sgpb-margin-right-20"><?php esc_html_e('Position right', 'popup-builder')?>:</span>
			...
			<div class="formItem formItem_itemsCentered">
				<span class="formItem__title sgpb-margin-right-20"><?php esc_html_e('Border size', 'popup-builder')?>:</span>
			...
			<div class="formItem formItem_itemsCentered">
				<span class="formItem__title sgpb-margin-right-20"><?php esc_html_e('Border radius', 'popup-builder')?>:</span>
			...
			<div class="formItem">
				<span class="formItem__title sgpb-margin-right-20"><?php esc_html_e('Border color', 'popup-builder')?>:</span>
		...
		<div class="formItem">
			<span class="formItem__title sgpb-margin-right-20"><?php esc_html_e('Background color', 'popup-builder')?>:</span>
			<div class="sgpb-color-picker-wrapper sgpb-overlay-color unhideColorPicker">
		...
		<div class="formItem">
			<span class="formItem__title sgpb-margin-right-20"><?php esc_html_e('Text color', 'popup-builder')?>:</span>
			<div class="sgpb-color-picker-wrapper sgpb-overlay-color unhideColorPicker">
		...
		<div class="formItem">
			<span class="formItem__title sgpb-margin-right-20"><?php esc_html_e('Text', 'popup-builder')?>:</span>
