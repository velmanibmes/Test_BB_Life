...
if ( ! class_exists( 'YWSBS_Subscription_Post_Type_Admin' ) ) {
	...
	class YWSBS_Subscription_Post_Type_Admin {
		...
		public function remove_meta_fix() {
			if ( isset( $_POST['meta'] ) && isset( $_POST['post_type'] ) && YITH_YWSBS_POST_TYPE === sanitize_text_field( wp_unslash( $_POST['post_type'] ) ) ) {  // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				unset( $_POST['meta'] );
			}
		}
