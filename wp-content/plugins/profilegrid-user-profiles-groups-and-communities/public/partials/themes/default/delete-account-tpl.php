<div class="pmagic">   
<!-----Form Starts----->
<form class="pmagic-form pm-dbfl pg-group-reg-form" method="post" action="" id="pm_delete_account" name="pm_delete_account" onsubmit="return pm_delete_account_setting(this);">
