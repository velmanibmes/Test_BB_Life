<div class="pmagic">
<!-----Form Starts----->
  <form class="pmagic-form pm-dbfl pg-group-reg-form" method="post" action="" id="pm_add_blog_post" name="pm_add_blog_post" onsubmit="return profile_magic_blogpost_validation()" enctype="multipart/form-data">
